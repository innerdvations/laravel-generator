...
class BaseCommand extends Command
{
    ...
    {
        $this->performPostActions(!$this->isSkip('run_migration'));
    }
    ...
    public function getOptions()
    {
        return [
            ...
            ['skip', null, InputOption::VALUE_REQUIRED, 'Skip Specific Items to Generate (migration,run_migration,model,controllers,api_controller,scaffold_controller,repository,requests,api_requests,scaffold_requests,routes,api_routes,scaffold_routes,views,tests,menu,dump-autoload)'],
